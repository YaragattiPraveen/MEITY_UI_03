...
const Add_Details_Purchase_History = ({ closemodel }) => {
  const [noOfPurchaseRows, setNoOfPurchaseRows] = useState(1);

  return (
    <>
      <div className="overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
      <div className="relative w-auto my-4 max-w-[300px] mx-auto md:max-w-lg lg:max-w-6xl">
          {/*content*/}
...
export default Add_Details_Purchase_History;
