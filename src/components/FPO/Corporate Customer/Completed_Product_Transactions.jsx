...
import ShowOngoingTransactions from "./Modal/Ongoing_Transactions/ShowOngoingTransactions";

const Completed_Product_Transactions = () => {
  ...
  return (
    <div className="bg-box__bg__color shadow-lg rounded-lg border border-gray-200 my-5">
      ...
      {modal.state === "ShowOrderDetails" && (
        <ShowOngoingTransactions show={false} handleClose={closeModal} />
      )}
    </div>
  );
};

export default Completed_Product_Transactions;
