...
import Show_Output_Customer_Bid_Status from "../Modal/BidStatus/Show_Output_Customer_Bid_Status"
...
const Completed_Transactions = () => {
    ...
    return (
        <div className="bg-box__bg__color shadow-lg rounded-lg border border-gray-200 my-5">
            ...
            {
                modal.state === "showBidInformation" && <Show_Output_Customer_Bid_Status show={false} handleClose={closeModal} />
            }
        </div>
    )
}
