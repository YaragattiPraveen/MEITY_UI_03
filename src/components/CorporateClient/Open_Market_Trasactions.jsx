...
import Ongoing_Product_Transactions from "./Tabs/Ongoing_Product_Transactions";
import Completed_Product_Transactions from "./Tabs/Completed_Product_Transactions";
const Open_Market_Trasactions = () => {
  const [active, setActive] = useState("tab1");

  let tab_UI;
  if (active === "tab1") {
    tab_UI = <Ongoing_Product_Transactions/>;
  } else if (active === "tab2") {
