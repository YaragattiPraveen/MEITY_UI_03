        ...
        <div className="flex-1 px-2 p:2 sm:p-6 justify-between flex flex-col h-screen bg-white__color shadow-2xl my-3 rounded-xl">
          <div className="flex sm:items-center justify-between py-2 border-b-2 border-gray-200">
            <div className="relative flex items-center space-x-2">
              ...
              <div className="flex flex-col leading-tight font-Roboto">
                <div className="text-lg flex items-center">
                  <span className="mr-3">Fpo - 1 </span>
                </div>
                <span className="text-md text-gray-600">Active</span>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <button
                type="button"
                className="inline-flex items-center justify-center rounded-lg border h-10 w-10 transition duration-500 ease-in-out text-bg__color hover:bg-hover__color hover:text-white__color focus:outline-none"
              >
                <svg
          ...
          >
            ...
            <div className="chat-message">
              <div className="flex items-end justify-end">
                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                  <div>
                    <span className="px-4 py-2 rounded-lg inline-block rounded-br-none shadow-lg bg-bg__color text-white ">
            ...
            <div className="chat-message">
              <div className="flex items-end">
                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                  <div>
                    <span className="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-hover__color text-white__color xl">
            ...
            <div className="chat-message">
              <div className="flex items-end justify-end">
                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                  <div>
                    <span className="px-4 py-2 rounded-lg inline-block shadow-lg bg-bg__color text-white ">
                      Are you using sudo?
                    </span>
                  </div>
                  <div>
            ...
            <div className="chat-message">
              <div className="flex items-end">
                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                  <div>
                    <span className="px-4 py-2 rounded-lg inline-block bg-hover__color text-white__color xl">
          ...
          <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <div className="relative flex">
              ...
              <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
                ...
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-bg__color hover:bg-hover__color focus:outline-none"
                >
