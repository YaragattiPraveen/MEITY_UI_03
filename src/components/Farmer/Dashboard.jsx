    ...
    <>
      <div className="container w-full mx-auto">
        ...
        <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-6 py-2">
          <div className="text-green-500 lg:pr-4 pb-5 text-xs sm:text-lg font-bold text-center rounded-lg col-span-4 row-span-3">
            <Slider title={"Store"} />
          </div>
          <div className="text-green-500 lg:pr-4 pb-5 text-lg font-bold text-center rounded-lg col-span-3 md:col-span-2 row-span-3">
            <Training_Programs />
          </div>
          <div className="text-green-500 lg:pr-4 pb-5 text-lg font-bold text-center rounded-lg col-span-4 row-span-3">
